...
from gnd_decoder.core import Abstractcode, Errormodel, Loading_code, MADE, NADE, TraDE_binary, mod2, read_code  # noqa: E402
...
if __name__ == '__main__':
    ...
    if save == True:
        path = ARTIFACTS_DIR / "code_capacity" / f"{n_type}_{c_type}_n{n}_d{d}_k{k}_seed{seed}_er{er}_{e_model}.pt"
