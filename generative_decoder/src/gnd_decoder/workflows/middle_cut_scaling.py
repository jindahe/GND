...
def parse_args():
    ...
    parser.add_argument("--output-json", default="artifacts/gnd/scaling/middle_cut_scaling.json")
    parser.add_argument("--output-csv", default="artifacts/gnd/scaling/middle_cut_scaling.csv")
