...
- [ ] **6a. 实现 chunk 并行脚本**（参数化 workers/chunk/samples）
- [ ] **6b. 跑 fast 配置**（`chi=16`，全点）
- [ ] **6c. 识别异常点**（负值或波动点）
- [ ] **6d. 关键点精修**（`chi=32/64` 覆盖）
- [ ] **6e. 生成最终图和 Eq.(12) 对比报告**


---

## 🟤 P7：下一步数据生成方案（2026-04-08 更新）
...
- [ ] **7a. 先补完 S1 四点校正**
- [ ] **7b. 生成 S2 的 Eq.(12) 校正后结论**
- [ ] **7c. 执行 A1（chi 收敛）确认截断误差**
- [ ] **7d. 执行 A2（多 seed）确认统计误差**
- [ ] **7e. 启动 B1 chunk 并行作为主生产路径**
