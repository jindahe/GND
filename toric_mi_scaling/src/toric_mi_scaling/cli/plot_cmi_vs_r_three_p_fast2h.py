...
RAW_CSV = str((ARTIFACTS_DIR / "CMI_vs_r_three_p_fast2h_raw.csv"))
SUMMARY_CSV = str((ARTIFACTS_DIR / "CMI_vs_r_three_p_fast2h_summary.csv"))
OUT_PNG = str((ARTIFACTS_DIR / "CMI_vs_r_p005_011_015_fast2h.png"))
