...
DEFAULT_IN_TABLE = RESULTS_DIR / "publication" / "CMI_paper_repro_main_table_v1.csv"
...
def main():
    args = parse_args()
    args.in_table = resolve_path(args.in_table)
    args.out_fit_csv = resolve_output_path(args.out_fit_csv)
    args.out_png = resolve_output_path(args.out_png)
    args.out_pdf = resolve_output_path(args.out_pdf)
