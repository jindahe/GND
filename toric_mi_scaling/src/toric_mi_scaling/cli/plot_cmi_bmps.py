...
from toric_mi_scaling.core.cmi_calculation import calculate_CMI_bMPS, define_geometry_geom1
...
RESULTS_CSV = str((ARTIFACTS_DIR / "CMI_bMPS_results.csv"))
PLOT_FILE   = str((ARTIFACTS_DIR / "CMI_bMPS_vs_p.png"))
