...
Outputs:
- artifacts/CMI_keypoints_chi_scan.csv
- artifacts/CMI_keypoints_chi_scan.png
"""
...
ROOT = RESULTS_DIR
OUT_CSV = ARTIFACTS_DIR / "CMI_keypoints_chi_scan.csv"
OUT_PNG = ARTIFACTS_DIR / "CMI_keypoints_chi_scan.png"
