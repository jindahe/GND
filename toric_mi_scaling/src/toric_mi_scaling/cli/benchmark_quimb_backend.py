...
Outputs:
  artifacts/quimb_region_benchmark.csv
  artifacts/quimb_cmi_benchmark.csv
  artifacts/quimb_bond_scan.csv
...
def run_region_benchmark(cases, seed=42, verbose=True):
    ...
    """
    from toric_mi_scaling.core.cmi_calculation import _contract, define_geometry_geom1
    from toric_mi_scaling.core.bmps_contraction import bMPS_contract_region
    from toric_mi_scaling.core.quimb_contraction import quimb_contract_region
...
def run_cmi_benchmark(cases, verbose=True):
    ...
    Returns list of result dicts.
    """
    from toric_mi_scaling.core.cmi_calculation import calculate_CMI, calculate_CMI_bMPS
    from toric_mi_scaling.core.quimb_contraction import calculate_CMI_quimb
...
def run_bond_scan(cases, verbose=True):
    ...
    Returns list of result dicts.
    """
    from toric_mi_scaling.core.cmi_calculation import calculate_CMI_bMPS
    from toric_mi_scaling.core.quimb_contraction import calculate_CMI_quimb
