...
Outputs:
- artifacts/CMI_keypoints_multiseed.csv
- artifacts/CMI_keypoints_multiseed_summary.csv
"""
...
ROOT = RESULTS_DIR
RAW_CSV = ARTIFACTS_DIR / "CMI_keypoints_multiseed.csv"
SUMMARY_CSV = ARTIFACTS_DIR / "CMI_keypoints_multiseed_summary.csv"
